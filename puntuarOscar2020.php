...
if ((isset($_POST["MM_insert"])) && (isset($_POST["1"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['1']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=6;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["2"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['2']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=7;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["3"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['3']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=8;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["4"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['4']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=9;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["5"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['5']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=10;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["6"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['6']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=11;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["7"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['7']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=12;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["8"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['8']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=13;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["9"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['9']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=14;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["10"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['10']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=15;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["11"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['11']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=16;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["12"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['12']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=17;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["13"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['13']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=18;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["14"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['14']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=19;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["15"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['15']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=20;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["16"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['16']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=21;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["17"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['17']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=22;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["18"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['18']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=23;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["19"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['19']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=24;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["20"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['20']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=25;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["21"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['21']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=26;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["22"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['22']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=27;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["23"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['23']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=28;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["24"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2020 SET CodNom='".$_POST['24']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=29;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
...
/*
 ...
 $insertSQL = "UPDATE usuarios set puntos=(SELECT  count(*) FROM usuprenom2020 uu join usuprenom2020 uc ON uu.CodPre=uc.CodPre 
...
mysql_select_db($database_conexion, $conexion);
$query_premiosynominados= "SELECT nombreR, nombreN, aka FROM Nominados2020, Premios, PreNom2020 WHERE Nominados2020.CodNom LIKE PreNom2020.CodNom AND Premios.CodPre LIKE PreNom2020.CodPre ORDER BY PreNom2020.CodPre ASC, nombreN ASC;";
...
//Nueva funcion 2020 para ver los puntajes de cada usuario Y para puntuar a todos los participantes


mysql_select_db($database_conexion, $conexion);
$query_otrousuario_oscar = "SELECT T.*, U.* FROM Torneos as T JOIN usuarios as U ON T.inscriptos=U.usuario WHERE CodTor='17' AND usuario !='ProfetaMundial' ORDER BY U.puntos DESC";
...
do { 
	...
	mysql_select_db($database_conexion, $conexion);-
	$query_puntos_usuario = sprintf("SELECT  count(*) FROM usuprenom2020 uu join usuprenom2020 uc ON uu.CodPre=uc.CodPre 
...
if (isset($_POST["puntuar"])) {
	mysql_select_db($database_conexion, $conexion);
	$query_otrousuario_oscar_puntuar = "SELECT T.*, U.* FROM Torneos as T JOIN usuarios as U ON T.inscriptos=U.usuario WHERE CodTor='17' AND usuario !='ProfetaMundial' ORDER BY U.puntos DESC";
	...
	do { 
		...
		$insertGoTo = "puntuarOscar2020.php";
			if (isset($_SERVER['QUERY_STRING'])) {
...
<form name="formularioscar" action="puntuarOscar2020.php" method="post">
...
<form action="puntuarOscar2020.php" method="post">
