...
//ACTUALIZAR LOS GRUPOS
  ...
  //meter todos los goles en variables
   ...
   $updateSQL2 = "UPDATE equipos SET puntos='".$PLP7."'+'".$PLP10."'+'".$PVP11."', golfav='".$BF."', golcon='".$BC."', difgol='".$BD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=5";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
     $updateSQL2 = "UPDATE equipos SET puntos='".$PVP7."'+'".$PLP9."'+'".$PLP12."', golfav='".$VF."', golcon='".$VC."', difgol='".$VD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=6";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE equipos SET puntos='".$PLP8."'+'".$PVP10."'+'".$PVP12."', golfav='".$PF."', golcon='".$PC."', difgol='".$PD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=7";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE equipos SET puntos='".$PVP8."'+'".$PVP9."'+'".$PLP11."', golfav='".$EF."', golcon='".$EC."', difgol='".$ED."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=8";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
  //PASAR LOS 2 MEJORES DEL GRUPO
  
         $actualizar_primero = "UPDATE partidos SET local=(SELECT nombre FROM equipos WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 0,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=27";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());
  
         $actualizar_segundo = "UPDATE partidos SET visitante=(SELECT nombre FROM equipos WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 1,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=25";
  mysql_select_db($database_conexion, $conexion);
...
if (isset($_POST['primero']))	{
  ...
  $actualizar_primero = "UPDATE partidos SET local='".$_POST['primero']."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=27";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());

  
  $actualizar_segundo = "UPDATE partidos SET visitante='".$_POST['segundo']."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=25";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_segundo = mysql_query($actualizar_segundo, $conexion) or die(mysql_error());
...
<div class="invisible" id="alterar">
		<form name="alterar" method="post" action="GB.php">
