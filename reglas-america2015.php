...
<div style="padding:10px;">
  <p><strong>Reglas de la Copa America:</strong></p>
  ...
  <p class="letraschicas">El/la ganador/a ganador/a o los/las ganadores/as del juego ser&aacute;n  aquellos usuarios que consigan mas puntos al termino de la Copa America Chile 2015. Para determinar los puntos de un usuario, se utilizaran  los criterios de puntuaci&oacute;n que se detallan en el Sistema de puntuaci&oacute;n.  </p>
  ...
  <p class="letraschicas">Se  entiende a partir de ahora como Resultado exacto, al n&uacute;mero  de goles que el local y el visitante tienen en ese partido siempre ligado a los  seleccionados correspondientes. Por ejemplo, el resultado exacto para el  partido Mexico-Uruguay, tendr&iacute;a la forma: &quot;Mexico 0 Uruguay 3&quot;;  de ninguna manera el Resultado exacto se refiere solamente al 0-3, como numero  de goles independiente de cualquier selecci&oacute;n (tener en cuenta para los  partidos de la segunda fase). <br />
    ...
    Por Resultado exacto real, se entiende a partir de ahora a  los equipos y sus respectivos goles en un partido determinado que se produzcan  en la Copa America Chile 2015. Resultado real del partido ser&aacute;  la variante correspondiente a victoria local, victoria visitante o empate que  se produzca en la Copa America Chile 2015.</p>
<p class="letraschicas">&nbsp;</p>
  ...
  <p class="letraschicas">Ejemplo 2: Si el Resultado exacto real del partido entre  Chile y Bolivia es:<br />
    Chile 3 Bolivia 0<br />
    Y el usuario introdujo en su pron&oacute;stico el resultado:<br />
    Chile 3 Bolivia 0<br />
...
<p class="letraschicas">Se entiende por Segunda Ronda, a la fase final del campeonato, (cuartos de final, las 2 semifinales, el partido por el 3&ordm; y 4&ordm; puesto y la final). Esta fase comenzar&aacute; con una serie de enfrentamientos de la que formaran parte los 2 primeros equipos clasificados de cada grupo y los 2 mejores terceros,  en un orden determinado en una serie de partidos, de los cuales siempre uno de los 2 equipos resultara ganador y otro perdedor (cuartos). Los ganadores se enfrentaran entre si en otra serie de partidos (semifinales). Los perdedores de cada una de estas semifinales disputaran entre si el partido por el 3&ordm; y 4&ordm; puesto (el ganador del partido ser&aacute; el 3&ordm; clasificado), y los ganadores de cada una de las 2 semifinales, jugaran la final. El ganador de la final sera el campe&oacute;n del torneo.</p>
  ...
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido entre el  primero del Grupo A y el mejor tercero es:<br />
    Chile 3 Paraguay 0<br />
    Y el usuario introdujo en su pron&oacute;stico el resultado:<br />
    Chile 0 Paraguay 0<br />
    Pero eligi&oacute; adem&aacute;s que el equipo clasificado despu&eacute;s de ese  enfrentamiento fue Chile, la puntuaci&oacute;n TOTAL referente a ese partido seria  de 0 puntos, porque el partido fue victoria local, y el resultado exacto no coincide. </p>
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido entre el  primero del Grupo A y el mejor tercero es:<br />
Chile 3 Brasil 0<br />
Y el usuario introdujo en su pron&oacute;stico sobre el primero del Grupo B mejor tercero el resultado:<br />Brasil 0 Chile 3<br />
...
<p class="letraschicas">&nbsp;</p>
  ...
  <p class="letraschicas">EJEMPLO: si el usuario incluyo en los cuartos de final a la seleccion de Uruguay y en la Copa America Chile 2015, Uruguay clasifica para los cuartos de final como primero o segundo de su grupo, el usuario se llevara 1 punto por esa selecci&oacute;n.</p>
  <p class="letraschicas">El usuario que acierte el equipo campe&oacute;n del torneo,  sumara 15 puntos a su resultado final. De la misma forma, el usuario que  inscriba como goleador el apellido del jugador, o UNO DE LOS JUGADORES que se adjudique mas goles en la  Copa America Chile 2015, incrementara su puntuaci&oacute;n en 10  unidades.</p>
  ...
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido de la final  es:<br />
    Uruguay 1 Chile 0 (campe&oacute;n Uruguay)<br />
  ...
  <p class="letraschicas">Ejemplo 2: Si el Resultado exacto real del partido de la final  es:<br />
    Uruguay 1 Chile 0 (campe&oacute;n Uruguay)<br />
    Y el usuario inscribi&oacute; para dicho partido lo siguiente:<br />
    Uruguay 0 Chile 0 campe&oacute;n: Uruguay<br />
  ...
  <p class="letraschicas">Ejemplo 3: Si el Resultado exacto real del partido de la  final es:<br />
    Uruguay 1 Chile 0 (campe&oacute;n Uruguay)<br />
    Y el usuario inscribi&oacute; para dicho partido lo siguiente:<br />
    Chile 0 Uruguay 1 (campe&oacute;n Uruguay)<br />
