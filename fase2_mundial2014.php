...
//ELIJO QUIEN PASA LA ELIMINATORIA
  ...
  $updateGoTo = "fase2_mundial2014.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<!-- Primera fila -->
    	<tr>
        	<td class="fixture"><?=consultaEquipo(49,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(49,$c,$d,'local');?>" name="local49"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(49,$c,$d,'glocal');?>" name="L49" id="L49" class="botoneschicos"/>
            </td>
            <td></td><td></td><td></td><td></td><td></td><td></td>
		<td class="fixture"><?=consultaEquipo(51,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(51,$c,$d,'local');?>" name="local51"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(51,$c,$d,'glocal');?>" name="L51" id="L51" class="botoneschicos"/>
            </td>
        </tr>
        ...
        <tr>
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(57,$c,$d,'local');?>" name="local57"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(57,$c,$d,'glocal');?>" name="L57" id="L57" class="botoneschicos"/>
            </td>    
		...
		<td class="fixture">  
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(59,$c,$d,'local');?>" name="local59"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(59,$c,$d,'glocal');?>" name="L59" id="L59" class="botoneschicos"/>
            </td> 
		<td></td>
        </tr>
        ...
        <!--tercera fila -->
        <tr>
        	<td class="fixture"><?=consultaEquipo(49,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(49,$c,$d,'visitante');?>" name="visitante49"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(49,$c,$d,'gvisitante');?>" name="V49" id="V49" class="botoneschicos"/>
            </td>
            <td></td><td></td><td></td><td></td><td></td><td></td>
		<td class="fixture"><?=consultaEquipo(51,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(51,$c,$d,'visitante');?>" name="visitante51"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(51,$c,$d,'gvisitante');?>" name="V51" id="V51" class="botoneschicos"/>
            </td>
        </tr>
        ...
        <tr>
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(61,$c,$d,'local');?>" name="local61"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(61,$c,$d,'glocal');?>" name="L61" id="L61" class="botoneschicos"/>
            </td>    
         	<td></td><td></td>
		...
		<td class="fixture">  
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(62,$c,$d,'local');?>" name="local62"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(62,$c,$d,'glocal');?>" name="L62" id="L62" class="botoneschicos"/>
            </td> <td></td><td></td> 
        </tr>
        <!-- Quinta fila -->
	<tr>
        	<td class="fixture"><?=consultaEquipo(50,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(50,$c,$d,'local');?>" name="local50"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(50,$c,$d,'glocal');?>" name="L50" id="L50" class="botoneschicos"/>
            </td>
            <td></td><td></td><td></td><td></td><td></td><td></td>
		<td class="fixture"><?=consultaEquipo(52,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(52,$c,$d,'local');?>" name="local52"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(52,$c,$d,'glocal');?>" name="L52" id="L52" class="botoneschicos"/>
            </td>
        </tr>
	...
	<tr>
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(57,$c,$d,'visitante');?>" name="visitante57"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(57,$c,$d,'gvisitante');?>" name="V57" id="V57" class="botoneschicos"/>
            </td>    
         	<td></td><td></td><td></td><td></td>
		<td class="fixture">  
            <!--si son iguales un select-->
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(59,$c,$d,'visitante');?>" name="visitante59"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(59,$c,$d,'gvisitante');?>" name="V59" id="V59" class="botoneschicos"/>
            </td> <td></td>
        </tr>
         <!-- Septima fila --> 
        
                <tr>
        	<td class="fixture"><?=consultaEquipo(50,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(50,$c,$d,'visitante');?>" name="visitante50"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(50,$c,$d,'gvisitante');?>" name="V50" id="V50" class="botoneschicos"/>
            </td>
            <td></td><td></td>
		<td><span>Actualizar los resultados</span></td> 
		...
		<td></td><td>
		<td class="fixture"><?=consultaEquipo(52,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(52,$c,$d,'visitante');?>" name="visitante52"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(52,$c,$d,'gvisitante');?>" name="V52" id="V52" class="botoneschicos"/>
            </td><td></td>
        </tr>
		...
		<!--si son iguales un select-->
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(63,$c,$d,'local');?>" name="local63"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(63,$c,$d,'glocal');?>" name="L63" id="L63" class="botoneschicos"/>
            </td>    
             <td class="fixture">
		<!--si son iguales un select-->
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(63,$c,$d,'visitante');?>" name="visitante63"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(63,$c,$d,'gvisitante');?>" name="V63" id="V63" class="botoneschicos"/>
            </td>
		<td></td><td></td><td></td>
        </tr>
        
        <!-- Novena fila, En esta se incluye al campeon-->
        <tr>
        	<td class="fixture"><?=consultaEquipo(53,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(53,$c,$d,'local');?>" name="local53"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(53,$c,$d,'glocal');?>" name="L53" id="L53" class="botoneschicos"/>
            </td>
            <td></td><td></td>
		...
		<td></td><td></td>
		<td class="fixture"><?=consultaEquipo(54,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(54,$c,$d,'local');?>" name="local54"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(54,$c,$d,'glocal');?>" name="L54" id="L54" class="botoneschicos"/>
            </td>
        </tr>
        ...
        <!-- Decima fila -->
          <tr>
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(58,$c,$d,'local');?>" name="local58"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(58,$c,$d,'glocal');?>" name="L58" id="L58" class="botoneschicos"/>
            </td>    
         	<td></td><td></td><td></td><td></td>
		<td class="fixture">  
            <!--si son iguales un select-->
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(60,$c,$d,'local');?>" name="local60"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(60,$c,$d,'glocal');?>" name="L60" id="L60" class="botoneschicos"/>
            </td><td></td>
        </tr>
        
        <!-- Undecima fila -->
                <tr>
        	<td class="fixture"><?=consultaEquipo(53,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(53,$c,$d,'visitante');?>" name="visitante53"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(53,$c,$d,'gvisitante');?>" name="V53" id="V53" class="botoneschicos"/>
            </td>
            <td></td><td></td><td></td><td></td><td></td><td></td>
		<td class="fixture"><?=consultaEquipo(54,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(54,$c,$d,'visitante');?>" name="visitante54"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(54,$c,$d,'gvisitante');?>" name="V54" id="V54" class="botoneschicos"/>
            </td>
        </tr>
        ...
        <!-- Duodecima fila -->
         <tr>
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(61,$c,$d,'visitante');?>" name="visitante61"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(61,$c,$d,'gvisitante');?>" name="V61" id="V61" class="botoneschicos"/>
            </td>    
         	<td></td><td></td>
		...
		<td class="fixture">  
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(62,$c,$d,'visitante');?>" name="visitante62"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(62,$c,$d,'gvisitante');?>" name="V62" id="V62" class="botoneschicos"/>
            </td> 
		<td></td><td></td>
        </tr>
        ...
        <!-- Decimotercer fila-->
	<tr>
        	<td class="fixture"><?=consultaEquipo(55,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(55,$c,$d,'local');?>" name="local55"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(55,$c,$d,'glocal');?>" name="L55" id="L55" class="botoneschicos"/>
            </td>
            <td></td><td></td><td></td><td></td><td></td><td></td>
		<td class="fixture"><?=consultaEquipo(56,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(56,$c,$d,'local');?>" name="local56"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(56,$c,$d,'glocal');?>" name="L56" id="L56" class="botoneschicos"/>
            </td>
        </tr>
        <!-- Decimocuarta linea -->
        <tr>
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(58,$c,$d,'visitante');?>" name="visitante58"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(58,$c,$d,'gvisitante');?>" name="V58" id="V58" class="botoneschicos"/>
            </td>    
         	<td></td><td></td><td></td><td></td>
		<td class="fixture">  
            <!--si son iguales un select-->
        	...
        	<?php } ?> 
            <input type="hidden" value="<?=consultaEquipo(60,$c,$d,'visitante');?>" name="visitante60"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(60,$c,$d,'gvisitante');?>" name="V60" id="V60" class="botoneschicos"/>
            </td> 
		<td></td>
        </tr>
        
        <!-- Decimoquinta fila, ultima del fixture-->
        
         <tr>
        	<td class="fixture"><?=consultaEquipo(55,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(55,$c,$d,'visitante');?>" name="visitante55"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(55,$c,$d,'gvisitante');?>" name="V55" id="V55" class="botoneschicos"/>
            </td>
            <td></td><td></td><td></td><td></td><td></td><td></td>
		<td class="fixture"><?=consultaEquipo(56,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(56,$c,$d,'visitante');?>" name="visitante56"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(56,$c,$d,'gvisitante');?>" name="V56" id="V56" class="botoneschicos"/>
            </td>
        </tr>
        ...
        <tr>
        	<td>Tercer y cuarto puesto </td>            
        	<td class="fixture"><?=consultaEquipo(64,$c,$d,'local');?><input type="hidden" value="<?=consultaEquipo(64,$c,$d,'local');?>" name="local64"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(64,$c,$d,'glocal');?>" name="L64" id="L64" class="botoneschicos"/>
            </td>
	<td class="fixture"><?=consultaEquipo(64,$c,$d,'visitante');?><input type="hidden" value="<?=consultaEquipo(64,$c,$d,'visitante');?>" name="visitante64"/> <input type="text" size="1" maxlength="2" value="<?=consultaEquipo(64,$c,$d,'gvisitante');?>" name="V64" id="V64" class="botoneschicos"/>
            </td>    
