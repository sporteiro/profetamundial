...
mysql_select_db($database_conexion,$conexion);
$consulta="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 1 AND 6 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultado=mysql_query($consulta, $conexion);

$consulta_tabla_A="SELECT * FROM equipos_mundial2018 WHERE grupo='A' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre";
$resultado_tabla_A=mysql_query($consulta_tabla_A, $conexion);



mysql_select_db($database_conexion,$conexion);
$consultaB="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 7 AND 12 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoB=mysql_query($consultaB, $conexion);

$consulta_tabla_B="SELECT * FROM equipos_mundial2018 WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_B=mysql_query($consulta_tabla_B, $conexion);


mysql_select_db($database_conexion,$conexion);
$consultaC="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 13 AND 18 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoC=mysql_query($consultaC, $conexion);

$consulta_tabla_C="SELECT * FROM equipos_mundial2018 WHERE grupo='C' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_C=mysql_query($consulta_tabla_C, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaD="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 19 AND 24 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoD=mysql_query($consultaD, $conexion);

$consulta_tabla_D="SELECT * FROM equipos_mundial2018 WHERE grupo='D' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_D=mysql_query($consulta_tabla_D, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultacuartos="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 25 AND 28 AND CodUsu='".$_SESSION['MM_Username']."'";
$resultadocuartos=mysql_query($consultacuartos, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaE="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 25 AND 30 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoE=mysql_query($consultaE, $conexion);

$consulta_tabla_E="SELECT * FROM equipos_mundial2018 WHERE grupo='E' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_E=mysql_query($consulta_tabla_E, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaF="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 31 AND 36 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoF=mysql_query($consultaF, $conexion);

$consulta_tabla_F="SELECT * FROM equipos_mundial2018 WHERE grupo='F' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_F=mysql_query($consulta_tabla_F, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaG="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 37 AND 42 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoG=mysql_query($consultaG, $conexion);

$consulta_tabla_G="SELECT * FROM equipos_mundial2018 WHERE grupo='G' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_G=mysql_query($consulta_tabla_G, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaH="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 43 AND 48 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadoH=mysql_query($consultaH, $conexion);

$consulta_tabla_H="SELECT * FROM equipos_mundial2018 WHERE grupo='H' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_H=mysql_query($consulta_tabla_H, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaoctavos="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 49 AND 56 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadooctavos=mysql_query($consultaoctavos, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultacuartos="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 57 AND 60 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadocuartos=mysql_query($consultacuartos, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultasemis="SELECT * FROM partidos_mundial2018 WHERE CodPar BETWEEN 61 AND 62 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultadosemis=mysql_query($consultasemis, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultafinal="SELECT * FROM partidos_mundial2018 WHERE CodPar=63 AND CodUsu='".$_SESSION['MM_Username']."'";
$resultadofinal=mysql_query($consultafinal, $conexion);
$filasresultadofinal=mysql_fetch_assoc($resultadofinal);

mysql_select_db($database_conexion,$conexion);
$consultatercer="SELECT * FROM partidos_mundial2018 WHERE CodPar=64 AND CodUsu='".$_SESSION['MM_Username']."'";
$resultadotercer=mysql_query($consultatercer, $conexion);
$filasresultadotercer=mysql_fetch_assoc($resultadotercer);


mysql_select_db($database_conexion,$conexion);
$consultagoleador="SELECT * FROM partidos_mundial2018 WHERE CodPar=66 AND CodUsu='".$_SESSION['MM_Username']."'";
$resultadogoleador=mysql_query($consultagoleador, $conexion);
$filasresultadogoleador=mysql_fetch_assoc($resultadogoleador);
										
mysql_select_db($database_conexion,$conexion);
$consultacampeon="SELECT * FROM partidos_mundial2018 WHERE CodPar=65  AND CodUsu='".$_SESSION['MM_Username']."'";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='profetamundial' and pp.resultado=ps.resultado and pp.CodPar<25 and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados2="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE (ps.CodUsu='".$_SESSION['MM_Username']."' AND pp.CodUsu='profetamundial') AND pp.resultado=ps.resultado AND (pp.CodPar BETWEEN 25 AND 31) AND pp.local=ps.local AND pp.visitante=ps.visitante AND pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='profetamundial' and pp.resultado=ps.resultado and pp.CodPar<25  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos2="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='profetamundial' and pp.resultado=ps.resultado AND (pp.CodPar BETWEEN 25 AND 31)  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante AND pp.local=ps.local AND pp.visitante=ps.visitante and pp.glocal!=99; ";
...
AND
(local in 
(select local from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar BETWEEN 25 AND 28)
OR local in 
(select visitante from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar BETWEEN 25 AND 28)
)
...
AND
(local in 
(select local from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar BETWEEN 29 AND 30)
OR local in 
(select visitante from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar BETWEEN 29 AND 30)
)
...
AND
(local in 
(select local from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar=31)
OR local in 
(select visitante from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar=31)
)
AND CodPar=31
)
UNION
...
AND
(local in 
(select local from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar=32)
OR local in 
(select visitante from partidos_mundial2018 where CodUsu='profetamundial' AND CodPar=32)
)
AND CodPar=32
)
UNION
...
CodPar=34 and 
local like (select local from partidos_mundial2018 where CodPar=34 and CodUsu='profetamundial')
and visitante=(select visitante from partidos_mundial2018 where CodPar=34 and CodUsu='profetamundial')
...
mysql_select_db($database_conexion,$conexion);
$consulta_campeon="SELECT count(*) as puntos from partidos_mundial2018 where CodPar=33 and local=(select local from partidos_mundial2018 where CodPar=33 and CodUsu='profetamundial') AND CodUsu='".$_SESSION['MM_Username']."'";
$resultado_campeon=mysql_query($consulta_campeon, $conexion);
$filas_campeon= mysql_fetch_assoc($resultado_campeon);


mysql_select_db($database_conexion,$conexion);
$consulta_tercero="SELECT count(*) as puntos from partidos_mundial2018 where CodPar=33 and visitante=(select visitante from partidos_mundial2018 where CodPar=33 and CodUsu='profetamundial') AND CodUsu='".$_SESSION['MM_Username']."'";
...
<title>Copa Mundial de la FIFA Brasil 2018</title>
...
<p class="letrasmasgrandes">Copa Mundial de la FIFA Brasil 2018</p>
<br />
