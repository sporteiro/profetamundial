...
//ACTUALIZAR LOS GRUPOS
  ...
  //meter todos los goles en variables
   ...
   $updateSQL2 = "UPDATE equipos_ol SET puntos='".$PLP7."'+'".$PLP9."'+'".$PLP11."', golfav='".$BF."', golcon='".$BC."', difgol='".$BD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=5";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
     $updateSQL2 = "UPDATE equipos_ol SET puntos='".$PVP7."'+'".$PLP10."'+'".$PLP12."', golfav='".$VF."', golcon='".$VC."', difgol='".$VD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=6";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE equipos_ol SET puntos='".$PLP8."'+'".$PVP9."'+'".$PVP12."', golfav='".$PF."', golcon='".$PC."', difgol='".$PD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=7";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE equipos_ol SET puntos='".$PVP8."'+'".$PVP10."'+'".$PVP11."', golfav='".$EF."', golcon='".$EC."', difgol='".$ED."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=8";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
  //PASAR LOS 2 MEJORES DEL GRUPO
  
         $actualizar_primero = "UPDATE partidos_ol SET local=(SELECT nombre FROM equipos_ol WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 0,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=27";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());
  
         $actualizar_segundo = "UPDATE partidos_ol SET visitante=(SELECT nombre FROM equipos_ol WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 1,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=25";
  mysql_select_db($database_conexion, $conexion);
...
$consulta_tabla_B="SELECT * FROM equipos_ol WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre";
...
if (isset($_POST['primero']))	{
  ...
  $actualizar_primero = "UPDATE partidos_ol SET local='".$_POST['primero']."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=27";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());

  
  $actualizar_segundo = "UPDATE partidos_ol SET visitante='".$_POST['segundo']."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=25";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_segundo = mysql_query($actualizar_segundo, $conexion) or die(mysql_error());
...
<div class="invisible" id="alterar">
		<form name="alterar" method="post" action="GB_ol.php">
