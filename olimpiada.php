...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados="SELECT COUNT(*) AS puntos FROM partidos_ol pp join partidos_ol ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='ProfetaMundial' and pp.resultado=ps.resultado and pp.CodPar<25 and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados2="SELECT COUNT(*) AS puntos FROM partidos_ol pp join partidos_ol ps  ON  pp.CodPar=ps.CodPar WHERE (ps.CodUsu='".$_SESSION['MM_Username']."' AND pp.CodUsu='ProfetaMundial') AND pp.resultado=ps.resultado AND (pp.CodPar BETWEEN 26 AND 31) AND pp.local=ps.local AND pp.visitante=ps.visitante AND pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos="SELECT COUNT(*) AS puntos FROM partidos_ol pp join partidos_ol ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='ProfetaMundial' and pp.resultado=ps.resultado and pp.CodPar<25  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos2="SELECT COUNT(*) AS puntos FROM partidos_ol pp join partidos_ol ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='ProfetaMundial' and pp.resultado=ps.resultado AND (pp.CodPar BETWEEN 26 AND 31)  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante AND pp.local=ps.local AND pp.visitante=ps.visitante and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_campeon="SELECT count(*) as puntos from partidos_ol where CodPar=33 and local=(select local from partidos_ol where CodPar=33 and CodUsu='ProfetaMundial') AND CodUsu='".$_SESSION['MM_Username']."'";
...
$total=$pexactos+$partidoGrupos+$puntospartidos_olegunda+$cuartos+$semis+$final+$pgoleador+$pcampeon;
?>
...
<br /><b>GRUPO A</b>
<br />
<iframe src="GA_ol.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>

<br /><b>GRUPO B</b>
<br />
<iframe src="GB_ol.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>

<br /><b>GRUPO C</b>
<br />
<iframe src="GC_ol.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>
<br />


<br /><b>GRUPO D</b>
<br />
<iframe src="GD_ol.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>
<br />

<br /><b>Segunda Fase</b>
<br />
<iframe src="fase2_ol.php" frameborder="0" scrolling="no" width="730px" height="760px"></iframe>



<!-- fin de la Derecha -->
<div style="clear: both;">
<a href="imprimirolimpiada.php" class="botones" target="_blank">Imprimir</a>
</div>
<br />
<hr />
<!-- Inicio de banners -->
