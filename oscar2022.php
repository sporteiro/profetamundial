...
if ((isset($_POST['1'])) && $fueraTiempo==0){
	//2022 elimino la categoria  25 ('".$_POST['usuarioimput']."', 25, '".$_POST['20']."'),
  $insertSQL = "INSERT INTO usuprenom2022 (CodUsu, CodPre, CodNom) VALUES
  ...
  ('".$_POST['usuarioimput']."', 26, '".$_POST['20']."'),
  ('".$_POST['usuarioimput']."', 27, '".$_POST['21']."'),
  ('".$_POST['usuarioimput']."', 28, '".$_POST['22']."'),
  ('".$_POST['usuarioimput']."', 29, '".$_POST['23']."') 
  ";
...
if (isset($_POST['1'])) {
  ...
  ('18','oscar2022', '".$_POST['usuarioimput']."','Oscar 2022')";
...
mysql_select_db($database_conexion, $conexion);
$query_usutor= "SELECT * FROM Torneos WHERE inscriptos='".$_SESSION['MM_Username']."' AND CodTor='18';";
...
<form method="post" action="oscar2022.php" name="formularioscar">
...
<br />
<a href="verelegidos2022.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2022</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
