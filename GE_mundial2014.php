...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "grupoE")) {
  ...
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());
   ...
   $updateSQL2 = "UPDATE equipos_mundial2014 SET puntos='".$PLP1."'+'".$PLP3."'+'".$PVP5."', golfav='".$AF."', golcon='".$AC."', difgol='".$AD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=17";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
     $updateSQL2 = "UPDATE equipos_mundial2014 SET puntos='".$PVP1."'+'".$PVP4."'+'".$PLP6."', golfav='".$BF."', golcon='".$BC."', difgol='".$BD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=18";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE equipos_mundial2014 SET puntos='".$PLP2."'+'".$PVP3."'+'".$PVP6."', golfav='".$CF."', golcon='".$CC."', difgol='".$CD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=19";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE equipos_mundial2014 SET puntos='".$PVP2."'+'".$PLP4."'+'".$PLP5."', golfav='".$RF."', golcon='".$RC."', difgol='".$RD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=20";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
...
//METER EN CUARTOS AL PRIMERO Y AL SEGUNDO
       ...
       $actualizar_primero = "UPDATE partidos_mundial2014 SET local=(SELECT nombre FROM equipos_mundial2014 WHERE grupo='E' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 0,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=53";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());
  
         $actualizar_segundo = "UPDATE partidos_mundial2014 SET visitante=(SELECT nombre FROM equipos_mundial2014 WHERE grupo='E' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 1,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=54";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_segundo = mysql_query($actualizar_segundo, $conexion) or die(mysql_error());
  
//RECARGBR LA PAGINA

  $updateGoTo = "GE_mundial2014.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion,$conexion);
$consulta="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 25 AND 30 AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY CodPar";
$resultado=mysql_query($consulta, $conexion);

$consulta_tabla_A="SELECT * FROM equipos_mundial2014 WHERE grupo='E' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre";
...
if (isset($_POST['primero']))	{
  ...
  $actualizar_primero = "UPDATE partidos_mundial2014 SET local='".$_POST['primero']."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=53";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());

  
  $actualizar_segundo = "UPDATE partidos_mundial2014 SET visitante='".$_POST['segundo']."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=54";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_segundo = mysql_query($actualizar_segundo, $conexion) or die(mysql_error());
...
<form name="grupoE" method="post" action="<?php echo $editFormAction; ?>">
...
<div class="invisible" id="alterar">
		<form name="alterar" method="post" action="GE_mundial2014.php">
