...
if ($Result1 = mysql_query($insertSQL, $conexion)) {
  $insertGoTo = "verelegidos2020.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_usuprenom2020= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2020, Premios WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND usuprenom2020.CodPre LIKE Premios.CodPre;";
$usuprenom2020= mysql_query($query_usuprenom2020, $conexion) or die(mysql_error());
$row_usuprenom2020= mysql_fetch_assoc($usuprenom2020);
$totalRows_usuprenom2020= mysql_num_rows($usuprenom2020);
...
<form name="formularioscar" action="moscar2020.php" method="post">
...
?>
	...
	<? } ?>
    <a href="verelegidos2020.php" class="botoneschicos">Ver mi pronostico</a>
