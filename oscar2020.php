...
if ((isset($_POST['1'])) && $fueraTiempo==0){
  ...
  $insertSQL = "INSERT INTO usuprenom2020 (CodUsu, CodPre, CodNom) VALUES
...
if (isset($_POST['1'])) {
  ...
  ('17','oscar2020', '".$_POST['usuarioimput']."','Oscar 2020')";
...
mysql_select_db($database_conexion, $conexion);
$query_usutor= "SELECT * FROM Torneos WHERE inscriptos='".$_SESSION['MM_Username']."' AND CodTor='17';";
...
</head><?php if ($_SESSION['MM_Username']=='ProfetaMundial')	{
...
<form method="post" action="oscar2020.php" name="formularioscar">
...
<div class="cada_nominado">
	<label>
	 ...
	 <b><?php echo $row_premiosynominados["nombreN"];?></b>&nbsp;<span class="letraschicas enlace_imdb"><i><?php  echo $row_premiosynominados["aka"]; ?></i> <a href="http://www.imdb.com/find?s=all&q=<?php echo $row_premiosynominados['nombreN'];?>" target="_blank">+info IMDb</a></span><br /></label>
<div class="clear"></div>
</div>
  <?php 
  }
...
<br />
<a href="verelegidos2020.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2020</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
