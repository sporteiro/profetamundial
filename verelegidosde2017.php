...
$query_usuprenom2017= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2017, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2017.CodPre LIKE Premios.CodPre;";
$usuprenom2017= mysqli_query($conexion, $query_usuprenom2017) or die(mysqli_error($conexion));
$row_usuprenom2017= mysqli_fetch_assoc($usuprenom2017);
$totalRows_usuprenom2017= mysqli_num_rows($usuprenom2017);
...
//VER PUNTOS
$query_puntaje = "SELECT count(*) as puntos FROM usuprenom2017 pp JOIN usuprenom2017 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<b>Pronostico de <?php echo $row_usuprenom2017['CodUsu']; ?> para los oscar 2017</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2017['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2017['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2017['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2017= mysqli_fetch_assoc($usuprenom2017))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
