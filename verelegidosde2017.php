...
//VER PUNTOS
mysql_select_db($database_conexion, $conexion);
$query_puntaje = "SELECT pp.*, pu.*, count(*) as puntos FROM usuprenom2017 pp JOIN usuprenom2017 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<?php } while ($row_usuprenom2017= mysql_fetch_assoc($usuprenom2017))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
