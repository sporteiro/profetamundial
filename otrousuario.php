...
$query_otrousuario ="SELECT CodUsu, CodNom, nombreR FROM usuprenom, Premios WHERE CodUsu LIKE '".$_GET['verlode']."' AND usuprenom.CodPre LIKE Premios.CodPre;";
...
<br />
<b>Pronostico de <?php echo $row_otrousuario['CodUsu']; ?> para los oscar 2010</b>
