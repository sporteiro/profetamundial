...
if ((isset($_POST['1'])) && $fueraTiempo==0){
  ...
  $insertSQL = "INSERT INTO usuprenom2019 (CodUsu, CodPre, CodNom) VALUES
...
if (isset($_POST['1'])) {
  ...
  ('16','oscar2019', '".$_POST['usuarioimput']."','Oscar 2019')";
...
mysql_select_db($database_conexion, $conexion);
$query_usutor= "SELECT * FROM Torneos WHERE inscriptos='".$_SESSION['MM_Username']."' AND CodTor='16';";
...
<form method="post" action="oscar2019.php" name="formularioscar">
...
<br />
<a href="verelegidos2019.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2019</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
