...
if ((isset($_POST['1'])) && $fueraTiempo==0){
  ...
  $insertSQL = "INSERT INTO usuprenom2017 (CodUsu, CodPre, CodNom) VALUES
...
if (isset($_POST['1'])) {
  ...
  ('13','oscar2017', '".$_POST['usuarioimput']."','Oscar 2017')";
...
mysql_select_db($database_conexion, $conexion);
$query_usutor= "SELECT * FROM Torneos WHERE inscriptos='".$_SESSION['MM_Username']."' AND CodTor='13';";
...
<form method="post" action="oscar2017.php" name="formularioscar">
...
<br />
<a href="verelegidos2017.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2017</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
...
<div id="final" class="final">
	...
	Dise&ntilde;o y desarrollo del sitio: <a href="http://www.sebastianporteiro.com">Sebastian Porteiro</a> <img src="http://www.sebastianporteiro.com.ar/favicon.ico" /><br />
