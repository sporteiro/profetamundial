...
('".$_SESSION['MM_Username']."', 19,'Primero Grupo A','Mejor Tercero', 0, 0, 0),
('".$_SESSION['MM_Username']."', 20,'Segundo Grupo A','Segundo Grupo C', 0, 0, 0),
('".$_SESSION['MM_Username']."', 21,'Primero Grupo B','Mejor Tercero 2', 0, 0, 0),
('".$_SESSION['MM_Username']."', 22,'Primero Grupo C','Segundo Grupo B', 0, 0, 0),

('".$_SESSION['MM_Username']."', 23,'Semifinalista 1','Semifinalista 2', 0, 0, 0),
('".$_SESSION['MM_Username']."', 24,'Semifinalista 3','Semifinalista 4', 0, 0, 0),
('".$_SESSION['MM_Username']."', 25,'Finalista 1','Finalista 2', 0, 0, 0),
('".$_SESSION['MM_Username']."', 26,'Tercer puesto 1','Tercer puesto 2', 0, 0, 0),
('".$_SESSION['MM_Username']."', 27,'Campeon','Tercero', 0, 0, 0),
('".$_SESSION['MM_Username']."', 28,'Goleador','Pais', 0, 0, 0);";
...
(11,'america2015','".$_SESSION['MM_Username']."', 'America 2015')";
  mysql_select_db($database_conexion, $conexion);
  $Resultamerica2 = mysql_query($insertSQLamerica2, $conexion) or die(mysql_error());
...
mysql_select_db($database_conexion, $conexion);
$query_usutor11= "SELECT * FROM Torneos WHERE inscriptos LIKE '".$_SESSION['MM_Username']."' AND CodTor='11';";
$usutor11= mysql_query($query_usutor11, $conexion) or die(mysql_error());
$row_usutor11= mysql_fetch_assoc($usutor11);
$totalRows_usutor11= mysql_num_rows($usutor11);
...
mysql_select_db($database_conexion, $conexion);
$query_otrousuario_oscar = "SELECT T.*, U.* FROM Torneos as T JOIN usuarios as U ON T.inscriptos=U.usuario WHERE CodTor='11' AND inscriptos !='ProfetaMundial' ORDER BY U.puntos DESC";
...
<br />
	...
	<strong>¿Quien ganara la Copa America 2015?</strong>
			...
			<div class="comentarios" style="text-align:center;">
     		   ...
     		   <?php do { ?>
                	<p>
				<?if ($row_otrousuario_oscar['inscriptos']!=$row_recordusuarios['usuario'])	{?>
    			   		<a class="botoneschicos" href="veramerica2015.php?verlode=<?php echo $row_otrousuario_oscar['inscriptos'];?>"> <?php echo $row_otrousuario_oscar['inscriptos'];?>  <b><?php echo $row_otrousuario_oscar['puntos'];?></b> puntos)</a>		
				<? } else {?>
					<span class="botoneschicos"><b><?echo $row_otrousuario_oscar['inscriptos']?> <?php echo $row_otrousuario_oscar['puntos'];?></b> puntos)</span>
				<?}?>
