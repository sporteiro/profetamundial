...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos2="SELECT * FROM usuarios WHERE usuario='".$_SESSION['MM_Username']."'";
...
<br /><b>GRUPO A</b>
<br />
<iframe src="A_GA.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>

<br /><b>GRUPO B</b>
<br />
<iframe src="A_GB.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>

<br /><b>GRUPO C</b>
<br />
<iframe src="A_GC.php" frameborder="0" scrolling="no" width="600px" height="370px"></iframe>
<br />
<br /><b>Segunda Fase</b>
<br />
<iframe src="A_fase2.php" frameborder="0" scrolling="no" width="730px" height="760px"></iframe>
