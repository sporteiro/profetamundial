...
if (isset($_POST['1'])) {
  $insertSQL = "INSERT INTO usuprenom (CodUsu, CodPre, CodNom) VALUES
...
if (isset($_POST['1'])) {
  ...
  ('1','oscar', '".$_POST['usuarioimput']."','Oscar 2012')";
...
<form method="post" action="oscar.php" name="formularioscar">
...
<br />
<a href="verelegidos.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2012</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
