...
$query_usuprenom= "SELECT CodUsu, CodNom, nombreR FROM usuprenom, Premios, preosc WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND usuprenom.CodPre LIKE Premios.CodPre AND usuprenom.CodPre LIKE preosc.premio AND usuprenom.CodNom LIKE preosc.ganador;";
$usuprenom= mysql_query($query_usuprenom, $conexion) or die(mysql_error());
$row_usuprenom= mysql_fetch_assoc($usuprenom);
$totalRows_usuprenom= mysql_num_rows($usuprenom);
...
<b>Pronostico de <?php echo $row_usuprenom['CodUsu']; ?> para los oscar 2010</b><br />
<b>Numero de aciertos: <?php echo $totalRows_usuprenom ?></b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom= mysql_fetch_assoc($usuprenom))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
		<a href="imprimiroscar.php" class="botoneschicos">imprimir</a>
        <br />
        </p>
	</div>
</div>
