...
//ELIJO QUIEN PASA LA ELIMINATORIA
			...
			function actualizarPartidos($nomEqu, $numPar,$locOvis,$c,$d)		{
				$updateSQL="UPDATE partidos_mundial2018 SET ".$locOvis."='".$nomEqu."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar='".$numPar."'";
				mysql_select_db($d,$c);
 ...
 /* $updateGoTo = "fase2_mundial2018.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
function consultaEquipo($partido,$c,$d,$consulta)	{
	mysql_select_db($d,$c);
	$consulta_partido="SELECT * FROM partidos_mundial2018 WHERE CodPar='".$partido."' AND CodUsu='".$_SESSION['MM_Username']."'";
...
mysql_select_db($database_conexion,$conexion);
$consulta_equipos_ol="SELECT nombre FROM equipos_mundial2018";
