...
mysql_select_db($database_conexion, $conexion);
$query_usuprenom2013= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2013, Premios WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND usuprenom2013.CodPre LIKE Premios.CodPre;";
$usuprenom2013= mysql_query($query_usuprenom2013, $conexion) or die(mysql_error());
$row_usuprenom2013= mysql_fetch_assoc($usuprenom2013);
$totalRows_usuprenom2013= mysql_num_rows($usuprenom2013);
...
<b>Pronostico de <?php echo $row_usuprenom2013['CodUsu']; ?> para los oscar 2013</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2013['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2013['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2013['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2013= mysql_fetch_assoc($usuprenom2013))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
		<a href="imprimiroscar2013.php" class="botoneschicos">imprimir</a> <!--<a href="moscar2013.php" class="botoneschicos">Modificar</a> -->
        <br />
        </p>
	</div>
</div>
