...
$query_usuprenom2014= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2014, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2014.CodPre LIKE Premios.CodPre;";
$usuprenom2014= mysqli_query($conexion, $query_usuprenom2014) or die(mysqli_error($conexion));
$row_usuprenom2014= mysqli_fetch_assoc($usuprenom2014);
$totalRows_usuprenom2014= mysqli_num_rows($usuprenom2014);
...
//VER PUNTOS
$query_puntaje = "SELECT count(*) as puntos FROM usuprenom2014 pp JOIN usuprenom2014 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<b>Pronostico de <?php echo $row_usuprenom2014['CodUsu']; ?> para los oscar 2014</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2014['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2014['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2014['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2014= mysqli_fetch_assoc($usuprenom2014))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
