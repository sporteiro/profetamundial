...
$usuprenom2014= mysql_query($query_usuprenom2014, $conexion) or die(mysql_error());
$row_usuprenom2014= mysql_fetch_assoc($usuprenom2014);
$totalRows_usuprenom2014= mysql_num_rows($usuprenom2014);
...
//VER PUNTOS
mysql_select_db($database_conexion, $conexion);
$query_puntaje = "SELECT pp.*, pu.*, count(*) as puntos FROM usuprenom2014 pp JOIN usuprenom2014 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<?php } while ($row_usuprenom2014= mysql_fetch_assoc($usuprenom2014))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
