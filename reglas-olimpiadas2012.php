...
<div style="padding:10px;">
  <p><strong>Reglas de Futbol masculino en los JJOO Londres 2012:</strong></p>
  ...
  <p class="letraschicas">El/la ganador/a ganador/a o los/las ganadores/as del juego ser&aacute;n  aquellos usuarios que consigan mas puntos al termino de la competicion de Futbol masculino en los JJOO Londres 2012. Para determinar los puntos de un usuario, se utilizaran  los criterios de puntuaci&oacute;n que se detallan en el Sistema de puntuaci&oacute;n.  </p>
  <p class="letraschicas"><strong>SISTEMA DE PUNTUACION:</strong></p>
  <p class="letraschicas">Se  entiende a partir de ahora como Resultado exacto, al n&uacute;mero  de goles que el local y el visitante tienen en ese partido siempre ligado a los  seleccionados correspondientes. Por ejemplo, el resultado exacto para el  partido Mexico-Uruguay, tendr&iacute;a la forma: &quot;Mexico 0 Uruguay 3&quot;;  de ninguna manera el Resultado exacto se refiere solamente al 0-3, como numero  de goles independiente de cualquier selecci&oacute;n (tener en cuenta para los  partidos de la segunda fase). <br />
    ...
    Por Resultado exacto real, se entiende a partir de ahora a  los equipos y sus respectivos goles en un partido determinado que se produzcan  en la competicion de Futbol masculino en los JJOO Londres 2012. Resultado real del partido ser&aacute;  la variante correspondiente a victoria local, victoria visitante o empate que  se produzca en la competicion de Futbol masculino en los JJOO Londres 2012.</p>
<p class="letraschicas">&nbsp;</p>
  <p class="letrasgrandes">FASE DE GRUPOS:</p>
  <p class="letraschicas">Se entiende que Fase de grupos se refiere a todos aquellos partidos disputados en forma de campeonato, en agrupaciones de cuatro selecciones, numeradas de la A a la C , que deben jugar entre si. Pasaran a la siguiente ronda los 2 primeros de cada grupo (en orden de puntos, diferencia de gol, goles a favor, orden alfabetico) y los 2 mejores terceros. </p>
  ...
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido entre  Mexico y Uruguay es:<br />
    Mexico 0 Uruguay 2<br />
    Y el usuario introdujo en su pron&oacute;stico el resultado:<br />
    Mexico 0 Uruguay 5<br />
    La puntuaci&oacute;n referente a este partido seria de 1 punto, por  acertar que el visitante fue quien gano.  </p>
  <p class="letraschicas">Ejemplo 2: Si el Resultado exacto real del partido entre  Senegal y Suiza es:<br />
    Senegal 3 Suiza 0<br />
    Y el usuario introdujo en su pron&oacute;stico el resultado:<br />
    Senegal 3 Suiza 0<br />
...
<p class="letraschicas">Se entiende por Segunda Ronda, a la fase final del campeonato, (cuartos de final, las 2 semifinales, el partido por el 3&ordm; y 4&ordm; puesto y la final). Esta fase comenzar&aacute; con una serie de enfrentamientos de la que formaran parte los 2 primeros equipos clasificados de cada grupo y los 2 mejores terceros,  en un orden determinado en una serie de partidos, de los cuales siempre uno de los 2 equipos resultara ganador y otro perdedor (cuartos). Los ganadores se enfrentaran entre si en otra serie de partidos (semifinales). Los perdedores de cada una de estas semifinales disputaran entre si el partido por el 3&ordm; y 4&ordm; puesto (el ganador del partido ser&aacute; el 3&ordm; clasificado), y los ganadores de cada una de las 2 semifinales, jugaran la final. El ganador de la final sera el campe&oacute;n del torneo.</p>
  ...
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido entre el  primero del Grupo A y el mejor tercero es:<br />
    Senegal 3 Chile 0<br />
    Y el usuario introdujo en su pron&oacute;stico el resultado:<br />
    Senegal 1 Chile 0<br />
    La puntuaci&oacute;n TOTAL referente a este partido seria de 2  puntos, por acertar que el local fue quien gano.  </p>
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido entre el  primero del Grupo A y el mejor tercero es:<br />
    Senegal 3 Gabon 0<br />
    Y el usuario introdujo en su pron&oacute;stico el resultado:<br />
    Senegal 0 Gabon 0<br />
    Pero eligi&oacute; adem&aacute;s que el equipo clasificado despu&eacute;s de ese  enfrentamiento fue Senegal, la puntuaci&oacute;n TOTAL referente a ese partido seria  de 0 puntos, porque el partido fue victoria local, y el resultado exacto no coincide. </p>
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido entre el  primero del Grupo A y el mejor tercero es:<br />
Senegal 3 Brasil 0<br />
Y el usuario introdujo en su pron&oacute;stico sobre el primero del Grupo B mejor tercero el resultado:<br />Brasil 0 Senegal 3<br />
La puntuaci&oacute;n TOTAL referente a ese partido seria  de 0 puntos, porque el partido NO COINCIDE CON EL PARTIDO REAL</p>
  
  <p class="letraschicas">En caso de empates en semifinales, el usuario deber&aacute; preocupase de que los  Resultados exactos en los partidos de semifinales guarden relaci&oacute;n con los  posteriores equipos seleccionados para el partido del tercer y cuarto puesto y  el partido de la final.</p>
<p class="letraschicas">&nbsp;</p>
  <p>EXTRAS:</p>
  ...
  <table width="630" border="0" cellpadding="0" cellspacing="3" class="tablaclasificacion">
    ...
    <tr>
      <td class="letraschicas">Equipo que coincide en una fase (cuartos, semifinales, 3&ordm; y 4&ordm;, final)</td>
      <td class="letraschicas">1</td>
    </tr>
    <tr>
  ...
  <p class="letraschicas">Ejemplo: Si el Resultado exacto real del partido de la final  es:<br />
    Uruguay 1 Senegal 0 (campe&oacute;n Uruguay)<br />
  ...
  <p class="letraschicas">Ejemplo 2: Si el Resultado exacto real del partido de la final  es:<br />
    Uruguay 1 Senegal 0 (campe&oacute;n Uruguay)<br />
    Y el usuario inscribi&oacute; para dicho partido lo siguiente:<br />
    Uruguay 0 Senegal 0 campe&oacute;n: Uruguay<br />
  ...
  <p class="letraschicas">Ejemplo 3: Si el Resultado exacto real del partido de la  final es:<br />
    Uruguay 1 Senegal 0 (campe&oacute;n Uruguay)<br />
    Y el usuario inscribi&oacute; para dicho partido lo siguiente:<br />
    Senegal 0 Uruguay 1 (campe&oacute;n Uruguay)<br />
...
<p class="letraschicas">&nbsp;</p>
  ...
  <p class="letraschicas">El miercoles 25 de Julio de 2011 a las 23:00 horas (GMT)  finalizara el plazo de admisi&oacute;n y/o modificaci&oacute;n para el juego. A partir de ese  momento, los usuarios ya registrados podr&aacute;n acceder a su cuenta, pero ya no  podr&aacute;n realizar modificaciones en la misma.</p>
<p class="letraschicas">&nbsp;</p>
  <p class="letraschicas">&nbsp;</p>
