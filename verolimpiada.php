...
mysql_select_db($database_conexion,$conexion);
$consulta="SELECT * FROM partidos_ol WHERE CodPar BETWEEN 1 AND 6 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultado=mysql_query($consulta, $conexion);

$consulta_tabla_A="SELECT * FROM equipos_ol WHERE grupo='A' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre";
$resultado_tabla_A=mysql_query($consulta_tabla_A, $conexion);



mysql_select_db($database_conexion,$conexion);
$consultaB="SELECT * FROM partidos_ol WHERE CodPar BETWEEN 7 AND 12 AND CodUsu='".$_GET['verlode']."'";
$resultadoB=mysql_query($consultaB, $conexion);

$consulta_tabla_B="SELECT * FROM equipos_ol WHERE grupo='B' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_B=mysql_query($consulta_tabla_B, $conexion);


mysql_select_db($database_conexion,$conexion);
$consultaC="SELECT * FROM partidos_ol WHERE CodPar BETWEEN 13 AND 18 AND CodUsu='".$_GET['verlode']."'";
$resultadoC=mysql_query($consultaC, $conexion);

$consulta_tabla_C="SELECT * FROM equipos_ol WHERE grupo='C' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_C=mysql_query($consulta_tabla_C, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaD="SELECT * FROM partidos_ol WHERE CodPar BETWEEN 19 AND 24 AND CodUsu='".$_GET['verlode']."'";
$resultadoD=mysql_query($consultaD, $conexion);

$consulta_tabla_D="SELECT * FROM equipos_ol WHERE grupo='D' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_D=mysql_query($consulta_tabla_D, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultacuartos="SELECT * FROM partidos_ol WHERE CodPar BETWEEN 25 AND 28 AND CodUsu='".$_GET['verlode']."'";
$resultadocuartos=mysql_query($consultacuartos, $conexion);


mysql_select_db($database_conexion,$conexion);
$consultasemis="SELECT * FROM partidos_ol WHERE CodPar BETWEEN 29 AND 30 AND CodUsu='".$_GET['verlode']."'";
$resultadosemis=mysql_query($consultasemis, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultafinal="SELECT * FROM partidos_ol WHERE CodPar=31 AND CodUsu='".$_GET['verlode']."'";
$resultadofinal=mysql_query($consultafinal, $conexion);
$filasresultadofinal=mysql_fetch_assoc($resultadofinal);

mysql_select_db($database_conexion,$conexion);
$consultatercer="SELECT * FROM partidos_ol WHERE CodPar=32 AND CodUsu='".$_GET['verlode']."'";
$resultadotercer=mysql_query($consultatercer, $conexion);
$filasresultadotercer=mysql_fetch_assoc($resultadotercer);


mysql_select_db($database_conexion,$conexion);
$consultagoleador="SELECT * FROM partidos_ol WHERE CodPar=34 AND CodUsu='".$_GET['verlode']."'";
$resultadogoleador=mysql_query($consultagoleador, $conexion);
$filasresultadogoleador=mysql_fetch_assoc($resultadogoleador);
										
mysql_select_db($database_conexion,$conexion);
$consultacampeon="SELECT * FROM partidos_ol WHERE CodPar=33  AND CodUsu='".$_GET['verlode']."'";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_ol pp join partidos_ol ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_GET['verlode']."' and pp.CodUsu='ProfetaMundial' and pp.resultado=ps.resultado and pp.CodPar<25 and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_ol pp join partidos_ol ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_GET['verlode']."' and pp.CodUsu='ProfetaMundial' and pp.resultado=ps.resultado and pp.CodPar<25  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante and pp.glocal!=99; ";
...
$consulta_cuartos="
(
SELECT local as cuartos FROM partidos_ol
WHERE CodUsu = '".$_GET['verlode']."'
AND
(local in 
(select local from partidos_ol where CodUsu='ProfetaMundial' AND CodPar BETWEEN 25 AND 28)
OR local in 
(select visitante from partidos_ol where CodUsu='ProfetaMundial' AND CodPar BETWEEN 25 AND 28)
)
AND CodPar BETWEEN 25 AND 28
)
UNION
(
SELECT visitante as cuartos FROM partidos_ol
WHERE CodUsu =  '".$_GET['verlode']."'
AND
( visitante in 
(select visitante from partidos_ol where CodUsu='ProfetaMundial' AND CodPar BETWEEN 25 AND 28)
...
AND
(local in 
(select local from partidos_ol where CodUsu='ProfetaMundial' AND CodPar BETWEEN 29 AND 30)
OR local in 
(select visitante from partidos_ol where CodUsu='ProfetaMundial' AND CodPar BETWEEN 29 AND 30)
)
...
AND
(local in 
(select local from partidos_ol where CodUsu='ProfetaMundial' AND CodPar=31)
OR local in 
(select visitante from partidos_ol where CodUsu='ProfetaMundial' AND CodPar=31)
)
AND CodPar=31
)
UNION
...
AND
(local in 
(select local from partidos_ol where CodUsu='ProfetaMundial' AND CodPar=32)
OR local in 
(select visitante from partidos_ol where CodUsu='ProfetaMundial' AND CodPar=32)
)
AND CodPar=32
)
UNION
...
mysql_select_db($database_conexion,$conexion);
$consulta_goleador="SELECT count(*) as puntos from partidos_ol where 
CodPar=34 and 
local like (select local from partidos_ol where CodPar=34 and CodUsu='ProfetaMundial')
and visitante=(select visitante from partidos_ol where CodPar=34 and CodUsu='ProfetaMundial')
...
mysql_select_db($database_conexion,$conexion);
$consulta_campeon="SELECT count(*) as puntos from partidos_ol where CodPar=33 and local=(select local from partidos_ol where CodPar=33 and CodUsu='ProfetaMundial') AND CodUsu='".$_GET['verlode']."'";
...
<title>Juegos Olimpicos Londres 2012 Futbol Masculino</title>
...
<p class="letrasmasgrandes">Juegos Olimpicos Londres 2012 Futbol Masculino</p>
<?
//Puntuaciones:
...
$total=$pexactos+$partidoGrupos+$puntospartidoSegunda+$cuartos+$semis+$tercer+$final+$pgoleador+$pcampeon;
?>
