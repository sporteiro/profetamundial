...
mysql_select_db($database_conexion, $conexion);
$query_usuprenom2014= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2014, Premios WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND usuprenom2014.CodPre LIKE Premios.CodPre;";
...
<!-- Fin del pronostico-->
	<div>
    	<p>
		<a href="imprimiroscar2014.php" class="botoneschicos">imprimir</a> 
		<?if ($fueraTiempo==0)	{	?>
			<a href="moscar2014.php" class="botoneschicos">Modificar</a> 
		<? } ?>
        <br />
        </p>
	</div>
