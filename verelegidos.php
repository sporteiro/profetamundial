...
mysql_select_db($database_conexion, $conexion);
$query_usuprenom= "SELECT CodUsu, CodNom, nombreR FROM usuprenom, Premios WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND usuprenom.CodPre LIKE Premios.CodPre;";
...
<b>Pronostico de <?php echo $row_usuprenom['CodUsu']; ?> para los oscar 2012</b>
...
<!-- Fin del pronostico-->
	<div>
    	<p>
		<a href="imprimiroscar.php" class="botoneschicos">imprimir</a> <!-- <a href="moscar.php" class="botoneschicos">Modificar</a> -->
        <br />
        </p>
	</div>
</div>
