...
if ((isset($_POST['1'])) && $fueraTiempo==0){
  ...
  $insertSQL = "INSERT INTO usuprenom2015 (CodUsu, CodPre, CodNom) VALUES
...
if (isset($_POST['1'])) {
  ...
  ('10','oscar2015', '".$_POST['usuarioimput']."','Oscar 2015')";
...
mysql_select_db($database_conexion, $conexion);
$query_usutor= "SELECT * FROM Torneos WHERE inscriptos='".$_SESSION['MM_Username']."' AND CodTor='10';";
...
<form method="post" action="oscar2015.php" name="formularioscar">
...
<br />
<a href="verelegidos2015.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2015</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
