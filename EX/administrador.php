...
if (isset($_POST['usuario'])) {
  ...
  $MM_fldUserAuthorization = "administrador";
  $MM_redirectLoginSuccess = "puntuar.php";
  $MM_redirectLoginFailed = "no.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_conexion, $conexion);
  	
  $LoginRS__query=sprintf("SELECT usuario, contrasena, administrador FROM usuarios WHERE usuario=%s AND contrasena=%s",
  ...
  if ($loginFoundUser) {
    ...
    $loginStrGroup  = mysql_result($LoginRS,0,'administrador');
...
<p><strong>Ingres&aacute; a tu cuenta de Administrador</strong></p>
<div class="letrasgrandes">
<div style="text-align: right; margin-right:30%;">
<form id="formadmin" name="formadmin" method="POST" action="<?php echo $loginFormAction; ?>">
