...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formamerica")) {
  $insertSQLamerica = "INSERT INTO partidos VALUES 

('".$_SESSION['MM_Username']."', 1, 'Polonia', 'Grecia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 2, 'Rusia', 'Rep.Checa', 0, 0, 0),
('".$_SESSION['MM_Username']."', 3, 'Grecia', 'Rep.Checa', 0, 0, 0),
('".$_SESSION['MM_Username']."', 4, 'Polonia', 'Rusia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 5, 'Grecia', 'Rusia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 6, 'Rep.Checa', 'Polonia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 7, 'Holanda', 'Dinamarca', 0, 0, 0),
('".$_SESSION['MM_Username']."', 8, 'Alemania', 'Portugal', 0, 0, 0),
('".$_SESSION['MM_Username']."', 9, 'Dinamarca','Portugal', 0, 0, 0),
...
('".$_SESSION['MM_Username']."', 13,'Espa�a','Italia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 14,'Irlanda','Croacia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 15,'Italia','Croacia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 16,'Espa�a','Irlanda', 0, 0, 0),
('".$_SESSION['MM_Username']."', 17,'Croacia','Espa�a', 0, 0, 0),
...
('".$_SESSION['MM_Username']."', 21,'Ucrania','Francia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 22,'Suecia','Inglaterra', 0, 0, 0),
('".$_SESSION['MM_Username']."', 23,'Suecia','Francia', 0, 0, 0),
('".$_SESSION['MM_Username']."', 24,'Inglaterra','Ucrania', 0, 0, 0),
...
$insertSQLamerica2 = "INSERT INTO equipos VALUES
('".$_SESSION['MM_Username']."', 1, 'Polonia', 'A', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 2, 'Grecia', 'A', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 3, 'Rusia', 'A', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 4, 'Rep.Checa', 'A', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 5, 'Holanda', 'B', '0', '0', '0', '0'),
...
('".$_SESSION['MM_Username']."', 9, 'Espa�a', 'C', '0', '0', '0', '0'),
...
('".$_SESSION['MM_Username']."', 13, 'Ucrania', 'D', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 14, 'Suecia', 'D', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 15, 'Francia', 'D', '0', '0', '0', '0'),
('".$_SESSION['MM_Username']."', 16, 'Inglaterra', 'D', '0', '0', '0', '0')";

  mysql_select_db($database_conexion, $conexion);
  $Resultamerica2 = mysql_query($insertSQLamerica2, $conexion) or die(mysql_error());
  
  $insertSQLamerica2 = "INSERT INTO Torneos VALUES
(4,'europa','".$_SESSION['MM_Username']."', 'Eurocopa')";
  mysql_select_db($database_conexion, $conexion);
  $Resultamerica2 = mysql_query($insertSQLamerica2, $conexion) or die(mysql_error());


  $insertGoTo = "europa.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_usutor4= "SELECT * FROM Torneos WHERE inscriptos LIKE '".$_SESSION['MM_Username']."' AND CodTor='4';";
...
mysql_select_db($database_conexion, $conexion);
$query_otrousuario_europa = "SELECT T.*, U.* FROM Torneos as T JOIN usuarios as U ON T.inscriptos=U.usuario WHERE CodTor='4' AND inscriptos NOT LIKE '".$_SESSION['MM_Username']."' ORDER BY U.puntos DESC";
...
mysql_select_db($database_conexion, $conexion);
$query_otrousuario_oscar = "SELECT T.*, U.* FROM Torneos as T JOIN usuarios as U ON T.inscriptos=U.usuario WHERE CodTor='1' AND inscriptos NOT LIKE '".$_SESSION['MM_Username']."' ORDER BY U.puntos DESC";
...
<div class="cabecera">
  ...
  <a href="modificar.php">Mi cuenta completa</a>
  		</p>   
...
<br />
	<div class="tablaclasificacion" style="width:410px; float:left; margin-left:20px; text-align:center; ">
		...
		<strong>�Quien ganara la Eurocopa?</strong>
			...
			<a href="europa.php" class="botoneschicos"> Ver o modificar mi pronostico</a>
			<?php } ?>
            ...
            <br />
     		   ...
     		   <?php do { ?>
                	<p>
    			   		<a class="botoneschicos" href="vereuropa.php?verlode=<?php echo $row_otrousuario_europa['inscriptos'];?>"> <?php echo $row_otrousuario_europa['inscriptos'];?>  (<b><?php echo $row_otrousuario_europa['puntos'];?></b> puntos)</a>
					</p>
...
<div class="tablaclasificacion" style="width:410px; float: right; margin-right :20px; text-align:center; ">
	...
	<?php do { ?>
			<div class="comentarios">
        		...
        		<strong><?php echo $row_recormentarios['usuario']; ?>  dijo:</strong> <?php echo $row_recormentarios['comentario']; ?></p>
			</div>
            <br />
