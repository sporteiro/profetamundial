...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='profetamundial' and pp.resultado=ps.resultado and pp.CodPar<49 and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_resultados2="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE (ps.CodUsu='".$_SESSION['MM_Username']."' AND pp.CodUsu='profetamundial') AND pp.resultado=ps.resultado AND (pp.CodPar BETWEEN 49 AND 64) AND pp.local=ps.local AND pp.visitante=ps.visitante AND pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='profetamundial' and pp.resultado=ps.resultado and pp.CodPar<49  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_puntos_exactos2="SELECT pp.*, ps.*, count(*) as 'puntos' FROM partidos_mundial2018 pp join partidos_mundial2018 ps  ON  pp.CodPar=ps.CodPar WHERE ps.CodUsu='".$_SESSION['MM_Username']."' and pp.CodUsu='profetamundial' and pp.resultado=ps.resultado AND (pp.CodPar BETWEEN 49 AND 64)  and pp.glocal=ps.glocal and pp.gvisitante=ps.gvisitante AND pp.local=ps.local AND pp.visitante=ps.visitante and pp.glocal!=99; ";
...
mysql_select_db($database_conexion,$conexion);
$consulta_campeon="SELECT count(*) as puntos from partidos_mundial2018 where CodPar=65 and local=(select local from partidos_mundial2018 where CodPar=65 and CodUsu='profetamundial') AND CodUsu='".$_SESSION['MM_Username']."'";
$resultado_campeon=mysql_query($consulta_campeon, $conexion);
$filas_campeon= mysql_fetch_assoc($resultado_campeon);

mysql_select_db($database_conexion,$conexion);
$consulta_tercero="SELECT count(*) as puntos from partidos_mundial2018 where CodPar=65 and visitante=(select visitante from partidos_mundial2018 where CodPar=65 and CodUsu='ProfetaMundial') AND CodUsu='".$_SESSION['MM_Username']."'";
...
<title>Mundial de Futbol Brasil 2018</title>
...
function resizeFase2()	{
	...
	if (w<800)	{
		//divFase2.src="fase2_mundial2018_cel.php";
		$('#fase2_mundial2018_cel').show();
		$('#fase2_mundial2018').hide();
	}
	else	{
		$('#fase2_mundial2018_cel').hide();
		$('#fase2_mundial2018').show();
		//divFase2.src="fase2_mundial2018.php";
	}
}
...
<p class="letrasmasgrandes">Mundial de Futbol Rusia 2018</p>
<?
//Puntuaciones:
...
<?php require_once('GA_mundial2018.php');?>
<!--<iframe src="GA_mundial2018.php" frameborder="0" scrolling="no" width="100%" height="100%"></iframe>-->
<div id="grupob" class="titulo_grupos">GRUPO B</div>
<?php require_once('GB_mundial2018.php');?>
<!--<iframe src="GB_mundial2018.php" frameborder="0" scrolling="no" width="100%" height="500px"></iframe>-->
<div id="grupoc" class="titulo_grupos">GRUPO C</div>
<?php require_once('GC_mundial2018.php');?>
<div id="grupod" class="titulo_grupos">GRUPO D</div>
<?php require_once('GD_mundial2018.php');?>
<div id="grupoe" class="titulo_grupos">GRUPO E</div>
<?php require_once('GE_mundial2018.php');?>
<div id="grupof" class="titulo_grupos">GRUPO F</div>
<?php require_once('GF_mundial2018.php');?>
<div id="grupog" class="titulo_grupos">GRUPO G</div>
<?php require_once('GG_mundial2018.php');?>
<div id="grupoh" class="titulo_grupos">GRUPO H</div>
<?php require_once('GH_mundial2018.php');?>
<div id="anchor_fase2">
<div id="grupoh" class="titulo_grupos">Segunda Fase</div>
<div id="fase2_mundial2018">
<?php require_once('fase2_mundial2018.php');?>
</div>
<div id="fase2_mundial2018_cel">
<?php require_once('fase2_mundial2018_cel.php');?>
</div>
</div>
<!--
<iframe src="fase2_mundial2018.php" id="fase2" frameborder="0" scrolling="no" width="100%" height="2000em;"></iframe>
-->
...
<br />
<div>
<a href="imprimirmundial2018.php" class="botoneschicos" target="_blank">Imprimir</a>
<div style="clear: both;"></div>
<!-- Final -->    
<div style="clear:both;"></div>  
