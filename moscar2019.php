...
if ($Result1 = mysql_query($insertSQL, $conexion)) {
  $insertGoTo = "verelegidos2019.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_usuprenom2019= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2019, Premios WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND usuprenom2019.CodPre LIKE Premios.CodPre;";
...
<form name="formularioscar" action="moscar2019.php" method="post">
...
?>
	...
	<? } ?>
    <a href="verelegidos2019.php" class="botoneschicos">Ver mi pronostico</a>
