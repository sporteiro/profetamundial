...
//ACTUALIZAR LOS GRUPOS
  ...
  //meter todos los goles en variables
   ...
   $updateSQL2 = "UPDATE america2015_equipos SET puntos='".$PLP7."'+'".$PVP10."'+'".$PLP11."', golfav='".$BF."', golcon='".$BC."', difgol='".$BD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=5";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
     $updateSQL2 = "UPDATE america2015_equipos SET puntos='".$PVP7."'+'".$PVP9."'+'".$PVP12."', golfav='".$VF."', golcon='".$VC."', difgol='".$VD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=6";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE america2015_equipos SET puntos='".$PLP8."'+'".$PLP10."'+'".$PLP12."', golfav='".$PF."', golcon='".$PC."', difgol='".$PD."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=7";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
       $updateSQL2 = "UPDATE america2015_equipos SET puntos='".$PVP8."'+'".$PLP9."'+'".$PVP11."', golfav='".$EF."', golcon='".$EC."', difgol='".$ED."' WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodEqu=8";
  mysql_select_db($database_conexion, $conexion);
  $Result2 = mysql_query($updateSQL2, $conexion) or die(mysql_error());
  
  //PASAR LOS 2 MEJORES DEL GRUPO
  
         $actualizar_primero = "UPDATE america2015_partidos SET local=(SELECT nombre FROM america2015_equipos WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 0,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=21";
  mysql_select_db($database_conexion, $conexion);
  $Result_actualizar_primero = mysql_query($actualizar_primero, $conexion) or die(mysql_error());
  
         $actualizar_segundo = "UPDATE america2015_partidos SET visitante=(SELECT nombre FROM america2015_equipos WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre LIMIT 1,1) WHERE CodUsu='".$_SESSION['MM_Username']."' AND CodPar=22";
  mysql_select_db($database_conexion, $conexion);
...
$consulta_tabla_B="SELECT * FROM america2015_equipos WHERE grupo='B' AND CodUsu='".$_SESSION['MM_Username']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre";
