...
mysql_select_db($database_conexion,$conexion);
$consulta="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 1 AND 6 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultado=mysql_query($consulta, $conexion);

$consulta_tabla_A="SELECT * FROM equipos_mundial2014 WHERE grupo='A' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre";
$resultado_tabla_A=mysql_query($consulta_tabla_A, $conexion);



mysql_select_db($database_conexion,$conexion);
$consultaB="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 7 AND 12 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoB=mysql_query($consultaB, $conexion);

$consulta_tabla_B="SELECT * FROM equipos_mundial2014 WHERE grupo='B' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_B=mysql_query($consulta_tabla_B, $conexion);


mysql_select_db($database_conexion,$conexion);
$consultaC="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 13 AND 18 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoC=mysql_query($consultaC, $conexion);

$consulta_tabla_C="SELECT * FROM equipos_mundial2014 WHERE grupo='C' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_C=mysql_query($consulta_tabla_C, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaD="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 19 AND 24 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoD=mysql_query($consultaD, $conexion);

$consulta_tabla_D="SELECT * FROM equipos_mundial2014 WHERE grupo='D' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_D=mysql_query($consulta_tabla_D, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultacuartos="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 25 AND 28 AND CodUsu='".$_GET['verlode']."'";
$resultadocuartos=mysql_query($consultacuartos, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaE="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 25 AND 30 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoE=mysql_query($consultaE, $conexion);

$consulta_tabla_E="SELECT * FROM equipos_mundial2014 WHERE grupo='E' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_E=mysql_query($consulta_tabla_E, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaF="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 31 AND 36 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoF=mysql_query($consultaF, $conexion);

$consulta_tabla_F="SELECT * FROM equipos_mundial2014 WHERE grupo='F' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_F=mysql_query($consulta_tabla_F, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaG="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 37 AND 42 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoG=mysql_query($consultaG, $conexion);

$consulta_tabla_G="SELECT * FROM equipos_mundial2014 WHERE grupo='G' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_G=mysql_query($consulta_tabla_G, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaH="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 43 AND 48 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadoH=mysql_query($consultaH, $conexion);

$consulta_tabla_H="SELECT * FROM equipos_mundial2014 WHERE grupo='H' AND CodUsu='".$_GET['verlode']."' ORDER BY puntos DESC, difgol DESC, golfav DESC, nombre DESC";
$resultado_tabla_H=mysql_query($consulta_tabla_H, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultaoctavos="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 49 AND 56 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadooctavos=mysql_query($consultaoctavos, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultacuartos="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 57 AND 60 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadocuartos=mysql_query($consultacuartos, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultasemis="SELECT * FROM partidos_mundial2014 WHERE CodPar BETWEEN 61 AND 62 AND CodUsu='".$_GET['verlode']."' ORDER BY CodPar";
$resultadosemis=mysql_query($consultasemis, $conexion);

mysql_select_db($database_conexion,$conexion);
$consultafinal="SELECT * FROM partidos_mundial2014 WHERE CodPar=63 AND CodUsu='".$_GET['verlode']."'";
$resultadofinal=mysql_query($consultafinal, $conexion);
$filasresultadofinal=mysql_fetch_assoc($resultadofinal);

mysql_select_db($database_conexion,$conexion);
$consultatercer="SELECT * FROM partidos_mundial2014 WHERE CodPar=64 AND CodUsu='".$_GET['verlode']."'";
$resultadotercer=mysql_query($consultatercer, $conexion);
$filasresultadotercer=mysql_fetch_assoc($resultadotercer);


mysql_select_db($database_conexion,$conexion);
$consultagoleador="SELECT * FROM partidos_mundial2014 WHERE CodPar=66 AND CodUsu='".$_GET['verlode']."'";
$resultadogoleador=mysql_query($consultagoleador, $conexion);
$filasresultadogoleador=mysql_fetch_assoc($resultadogoleador);
										
mysql_select_db($database_conexion,$conexion);
$consultacampeon="SELECT * FROM partidos_mundial2014 WHERE CodPar=65  AND CodUsu='".$_GET['verlode']."'";
...
mysql_select_db($database_conexion,$conexion);
$consulta_campeon="SELECT count(*) as puntos from partidos_mundial2014 where CodPar=65 and local=(select local from partidos_mundial2014 where CodPar=65 and CodUsu='profetamundial') AND CodUsu='".$_GET['verlode']."'";
$resultado_campeon=mysql_query($consulta_campeon, $conexion);
$filas_campeon= mysql_fetch_assoc($resultado_campeon);

mysql_select_db($database_conexion,$conexion);
$consulta_tercero="SELECT count(*) as puntos from partidos_mundial2014 where CodPar=65 and visitante=(select visitante from partidos_mundial2014 where CodPar=65 and CodUsu='ProfetaMundial') AND CodUsu='".$_GET['verlode']."'";
...
<title>Copa Mundial FIFA Brasil 2014</title>
...
<p class="letrasmasgrandes">Copa Mundial FIFA Brasil 2014</p>
<?
//Puntuaciones:
