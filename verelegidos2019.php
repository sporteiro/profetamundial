...
<b>Pronostico de <?php echo $row_usuprenom2019['CodUsu']; ?> para los oscar 2019</b>
...
<!-- Fin del pronostico-->
	<div>
    	<p>
		<a href="imprimiroscar2019.php" class="botoneschicos">imprimir</a> 
		<?if ($fueraTiempo==0)	{	?>
			<a href="moscar2019.php" class="botoneschicos">Modificar</a> 
		<? } ?>
        <br />
        </p>
	</div>
