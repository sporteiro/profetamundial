...
mysql_select_db($database_conexion, $conexion);
$query_usuprenom2013= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2013, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2013.CodPre LIKE Premios.CodPre;";
