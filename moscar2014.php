...
if ((isset($_POST["MM_insert"])) && (isset($_POST["1"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['1']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=6;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["2"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['2']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=7;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["3"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['3']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=8;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["4"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['4']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=9;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["5"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['5']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=10;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["6"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['6']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=11;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["7"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['7']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=12;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["8"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['8']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=13;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["9"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['9']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=14;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["10"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['10']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=15;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["11"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['11']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=16;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["12"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['12']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=17;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["13"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['13']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=18;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["14"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['14']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=19;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["15"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['15']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=20;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());}
  if ((isset($_POST["MM_insert"])) && (isset($_POST["16"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['16']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=21;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["17"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['17']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=22;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["18"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['18']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=23;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["19"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['19']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=24;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["20"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['20']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=25;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["21"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['21']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=26;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["22"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['22']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=27;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["23"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['23']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=28;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  }
  if ((isset($_POST["MM_insert"])) && (isset($_POST["24"])) && ($_POST["MM_insert"] == "formularioscar")) {
  $insertSQL = "UPDATE usuprenom2014 SET CodNom='".$_POST['24']."' WHERE CodUsu LIKE '".$_SESSION['MM_Username']."' AND CodPre=29;";
  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
  
}
if ($Result1 = mysql_query($insertSQL, $conexion)) {
  $insertGoTo = "verelegidos2014.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_premiosynominados= "SELECT nombreR, nombreN, aka FROM Nominados2014, Premios, PreNom2014 WHERE Nominados2014.CodNom LIKE PreNom2014.CodNom AND Premios.CodPre LIKE PreNom2014.CodPre ORDER BY PreNom2014.CodPre ASC, nombreN ASC;";
...
<form name="formularioscar" action="moscar2014.php" method="post">
...
while ($row_premiosynominados= mysql_fetch_assoc($premiosynominados))
{
  ...
  $ult_tipo = $row_premiosynominados["nombreR"];
	...
	<? } ?>
    <a href="verelegidos2014.php" class="botoneschicos">Ver mi pronostico</a>
