...
$query_usuprenom2015= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2015, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2015.CodPre LIKE Premios.CodPre;";
$usuprenom2015= mysqli_query($conexion, $query_usuprenom2015) or die(mysqli_error($conexion));
$row_usuprenom2015= mysqli_fetch_assoc($usuprenom2015);
$totalRows_usuprenom2015= mysqli_num_rows($usuprenom2015);
...
//VER PUNTOS
$query_puntaje = "SELECT count(*) as puntos FROM usuprenom2015 pp JOIN usuprenom2015 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<b>Pronostico de <?php echo $row_usuprenom2015['CodUsu']; ?> para los oscar 2015</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2015['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2015['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2015['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2015= mysqli_fetch_assoc($usuprenom2015))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
