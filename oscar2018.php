...
if ((isset($_POST['1'])) && $fueraTiempo==0){
  ...
  $insertSQL = "INSERT INTO usuprenom2018 (CodUsu, CodPre, CodNom) VALUES
...
if (isset($_POST['1'])) {
  ...
  ('14','oscar2018', '".$_POST['usuarioimput']."','Oscar 2018')";
...
mysql_select_db($database_conexion, $conexion);
$query_usutor= "SELECT * FROM Torneos WHERE inscriptos='".$_SESSION['MM_Username']."' AND CodTor='14';";
...
<form method="post" action="oscar2018.php" name="formularioscar">
...
<br />
<a href="verelegidos2018.php" class="botoneschicos"> Ver mi pronostico para los Oscar 2018</a>
<div style="clear:both;"></div>
<br />
<?php } ?>
</div>
