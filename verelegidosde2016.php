...
$query_usuprenom2016= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2016, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2016.CodPre LIKE Premios.CodPre;";
$usuprenom2016= mysqli_query($conexion, $query_usuprenom2016) or die(mysqli_error($conexion));
$row_usuprenom2016= mysqli_fetch_assoc($usuprenom2016);
$totalRows_usuprenom2016= mysqli_num_rows($usuprenom2016);
...
//VER PUNTOS
$query_puntaje = "SELECT count(*) as puntos FROM usuprenom2016 pp JOIN usuprenom2016 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<b>Pronostico de <?php echo $row_usuprenom2016['CodUsu']; ?> para los oscar 2016</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2016['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2016['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2016['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2016= mysqli_fetch_assoc($usuprenom2016))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
