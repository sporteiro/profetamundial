...
//VER PUNTOS
mysql_select_db($database_conexion, $conexion);
$query_puntaje = "SELECT pp.*, pu.*, count(*) as puntos FROM usuprenom2016 pp JOIN usuprenom2016 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<?php } while ($row_usuprenom2016= mysql_fetch_assoc($usuprenom2016))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
