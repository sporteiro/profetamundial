...
//VER PUNTOS
mysql_select_db($database_conexion, $conexion);
$query_puntaje = "SELECT pp.*, pu.*, count(*) as puntos FROM usuprenom2020 pp JOIN usuprenom2020 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<?php } while ($row_usuprenom2020= mysql_fetch_assoc($usuprenom2020))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
