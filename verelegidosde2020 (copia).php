...
$query_usuprenom2020= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2020, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2020.CodPre LIKE Premios.CodPre;";
$usuprenom2020= mysqli_query($conexion, $query_usuprenom2020) or die(mysqli_error($conexion));
$row_usuprenom2020= mysqli_fetch_assoc($usuprenom2020);
$totalRows_usuprenom2020= mysqli_num_rows($usuprenom2020);
...
//VER PUNTOS
$query_puntaje = "SELECT count(*) as puntos FROM usuprenom2020 pp JOIN usuprenom2020 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<b>Pronostico de <?php echo $row_usuprenom2020['CodUsu']; ?> para los oscar 2020</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2020['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2020['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2020['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2020= mysqli_fetch_assoc($usuprenom2020))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
