...
$query_usuprenom2018= "SELECT CodUsu, CodNom, nombreR FROM usuprenom2018, Premios WHERE CodUsu LIKE '".$_GET['usuario']."' AND usuprenom2018.CodPre LIKE Premios.CodPre;";
$usuprenom2018= mysqli_query($conexion, $query_usuprenom2018) or die(mysqli_error($conexion));
$row_usuprenom2018= mysqli_fetch_assoc($usuprenom2018);
$totalRows_usuprenom2018= mysqli_num_rows($usuprenom2018);
...
//VER PUNTOS
$query_puntaje = "SELECT count(*) as puntos FROM usuprenom2018 pp JOIN usuprenom2018 pu ON pp.CodPre=pu.CodPre WHERE pp.CodUsu='".$_GET['usuario']."' AND pu.CodUsu='ProfetaMundial' AND pp.CodNom=pu.CodNom";
...
<b>Pronostico de <?php echo $row_usuprenom2018['CodUsu']; ?> para los oscar 2018</b>
...
<?php do { ?> 
	<p>
	<b><?php echo $row_usuprenom2018['nombreR'];?></b>:&nbsp;<?php echo $row_usuprenom2018['CodNom'];?>:&nbsp;<span class="letraschicas"><a href="http://www.imdb.com/find?s=all&q=<?php echo $row_usuprenom2018['CodNom'];?>" target="_blank">+info IMDb</a></span><br />
    </p>
<?php } while ($row_usuprenom2018= mysqli_fetch_assoc($usuprenom2018))?>
</div>
<!-- Fin del pronostico-->
	<div>
    	<p>
