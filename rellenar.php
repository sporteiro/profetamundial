...
<title>Rellenar a mano</title>
<link href="estiloblanco.css" rel="stylesheet" type="text/css" />
<link rel="shortcut icon" href="favicon.ico"/>
</head>

<body>
<div id="contenedora" class="contenedora"><br />
<div id="partidos">
...
<table width="500" border="0" cellpadding="0" cellspacing="3" class="tablaclasificacion" style="margin:0 auto;">
  <tr>
    ...
    <td width="134"><label>
      <input name="textfield" type="text" id="textfield" size="2" maxlength="0" />
    </label></td>
    <td width="191">Mexico</td>
    <td width="14"><input name="textfield" type="text" id="textfield" size="2" maxlength="0" /></td>
    <td width="17">&nbsp;</td>
  </tr>
  <tr>
    <td>Uruguay</td>
    <td><input name="textfield" type="text" id="textfield" size="2" maxlength="0" /></td>
    <td>Francia </td>
    <td><input name="textfield" type="text" id="textfield" size="2" maxlength="0" /></td>
    <td>&nbsp;</td>
  </tr>
...
<table width="500" border="0" cellpadding="0" cellspacing="3" class="tablaclasificacion" style="margin:0 auto;">
  <tr>
    ...
    <td width="134"><input name="textfield" type="text" id="textfield" size="2" maxlength="0" /></td>
...
<table width="600" height="auto" border="0" cellpadding="0" cellspacing="0" class="tablaresultados">
  <tr>
    <td width="132" class="fixtureIZ">1A</td>
    ...
    <td width="25" class="fixtureIZ">1B</td>
  </tr>
  <tr>
    <td class="lineaderecha">&nbsp;</td>
    <td class="fixtureIZ">&nbsp;</td>
  ...
  <tr>
    ...
    <td class="lineavertical">&nbsp;</td>
    <td class="lineavertical">&nbsp;</td>
    <td class="fixtureIZ">Goleador:</td>
    <td class="lineaderecha">&nbsp;</td>
    <td class="lineaderecha">&nbsp;</td>
    <td class="fixture">&nbsp;</td>
    <td class="lineavertical">&nbsp;</td>
  ...
  <tr>
    <td height="18" class="fixtureIZ">2H</td>
    <td class="lineavertical">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
