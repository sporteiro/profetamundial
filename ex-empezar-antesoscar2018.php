...
mysql_select_db($database_conexion, $conexion);
$query_usutor13= "SELECT * FROM Torneos WHERE inscriptos LIKE '".$_SESSION['MM_Username']."' AND CodTor='13';";
$usutor13= mysql_query($query_usutor13, $conexion) or die(mysql_error());
$row_usutor13= mysql_fetch_assoc($usutor13);
$totalRows_usutor13= mysql_num_rows($usutor13);
...
mysql_select_db($database_conexion, $conexion);
$query_otrousuario_oscar = "SELECT T.*, U.* FROM Torneos as T JOIN usuarios as U ON T.inscriptos=U.usuario WHERE CodTor='13' AND inscriptos NOT LIKE '".$_SESSION['MM_Username']."' AND usuario !='ProfetaMundial' ORDER BY U.puntos DESC";
...
<br />
	<div class="tablaIzquierda">
    	...
    	<div class="comentarios" style="text-align:center;">
           	...
           	<p>
	<strong>\BFQuien ganara la Copa America 2015?</strong>
        	</p>
  			<?php if (!$row_usutor4['nombreT']) { ?>
            	<form id="formamerica" name="formamerica" method="post" action="<?php echo $editFormAction; ?>">
                	<input type="submit" class="botoneschicosrojos" value="\A1Pronosticar ahora!" />
	...
	<div class="comentarios" style="text-align:center;">
		<p>
<strong>Oscar 2017</strong>
        	</p>
  			<?php if (!$row_usutor13['nombreT']) { ?>
			<a href="oscar2017.php" class="botoneschicosrojos"> Pronosticar</a>
			<? } 
			else { ?>
			<a href="verelegidos2017.php" class="botoneschicos"> Ver o modificar mi pronostico</a>
			<?php } ?>
    		           <hr /> 
			...
			<div class="comentarios" style="text-align:center;">
     		   ...
     		   <?php do { ?>
                	<p>
    			   		<a class="botoneschicos" href="verelegidosde2017.php?usuario=<?php echo $row_otrousuario_oscar['inscriptos'];?>"> <?php echo $row_otrousuario_oscar['inscriptos'];?>  <b><?php echo $row_otrousuario_oscar['puntos'];?></b> puntos)</a>
					</p>
